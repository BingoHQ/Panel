...
new Vue({
    ...
    data() {
        return {
            //baseUrl: 'http://api.test', // local: panel base
            baseUrl: 'https://my.bingo.ir', // production: panel base
        }
    },
    http: {
        //root: 'http://api.test/rest/v3',// local: panel base
        root: 'https://my.bingo.ir/rest/v3',// production: panel base
    },
    created() {
